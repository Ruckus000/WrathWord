...
describe('keyboard state - characterization', () => {
  ...
  describe('multi-guess scenarios', () => {
    it('accumulates best states across multiple guesses', () => {
      ...
      states = updateKeyboardStates(states, 'CRANE', ['absent', 'absent', 'present', 'absent', 'correct']);
      ...
      states = updateKeyboardStates(states, 'SLATE', ['absent', 'absent', 'correct', 'absent', 'correct']);
      ...
      states = updateKeyboardStates(states, 'SHARE', ['absent', 'absent', 'absent', 'absent', 'correct']);
